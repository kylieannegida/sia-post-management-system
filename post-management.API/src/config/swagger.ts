...
const options = {
  definition: {
    ...
    // Define API metadata
    info: {
      title: "Post Management System", // Name of your API
      version: "1.0.0", // API version
      description: "API documentation for Web API 101 - Post Management System", // Brief description
      contact: {
        name: "Kylie Anne Gida", // Contact person
        email: "kylieannegida@gmail.com", // Contact email
      },
    },
    ...
    servers: [
      ...
      {
        url: "https://sia-post-management.onrender.com", // Production server
